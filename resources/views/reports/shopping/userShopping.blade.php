                                ...
                                @if(count($historialCompras))
                                    ...
                                    @foreach($historialCompras as $compras)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$compras->amount + $system->value}} $</td>
                                            <td>{{$compras->membership ? $compras->membership->type: ''}}</td>
                                            <td> Coinbase</td>
                                            @if($compras->status == 'V')
                                            <td><span class="badge badge-success">{{__('Pagado')}}</span></td>
                                            @elseif($compras->status== 'P')
                                             <td><span class="badge badge-warning">{{__('Pendiente')}}</span></td>
                                            @else
                                             <td><span class="badge badge-danger">{{__('Cancelado')}}</span></td>
                                            @endif
                                        </tr>
                                    @endforeach
                                @else
