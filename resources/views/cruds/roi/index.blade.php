                ...
                <div class="col-lg-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            {{ Form::open(['route'=> ['roi.search.filters'] ,'method'=>'POST', "id" => "formFilters", 'name' => "formFilters"]) }}
                            {{ Form::token() }}
                            ...
                            <a class="btn btn-outline-dark mr-2" href="{{route('roiPayment.index')}}">{{__('Limpiar')}}</a>
                            {{Form::close() }}
                        </div>
                    </div>
                </div>
                            ...
                            <div class="iq-card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="actual-tab" role="tabpanel">
                                        @include("cruds.payment.partials.list",["route"=>'roi.action',"payments"=>$payments])
                                    </div>
                                </div>
                            </div>
                        </div>
